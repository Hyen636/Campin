...
request.view = function(max, category, state, sno, title){
	...
	switch(category){
        ...
        if(s == ("R")){
           ...
           frm.action="manager_request_join_view";
        }else if(s == ("M")){
           frm.hisUserSno.value=num;
           frm.action="manager_request_modify_view";
        }else{
		...
		case"탈퇴":
			...
			frm.hisUserSno.value=num;
			frm.hisItemSno.value=num;
			frm.action='manager_general_request_view';
		break;
		//일반문의
		case"일반문의":
			frm.sno.value=num;
		...
		case"리뷰":
			...
			frm.hisUserSno.value=num;
			frm.hisItemSno.value=num;
			frm.action='manager_review_request_view';
		break;
