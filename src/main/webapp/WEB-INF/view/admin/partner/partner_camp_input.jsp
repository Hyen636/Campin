...
<div id='camping_input'>
		<span>캠핑장 등록하기</span>
		<form id="frm_camp_input" method="post">
			...
			<div>
				...
				<label>매너 타임</label>
				<input type="time" name="mStr"> - <input type="time" name="mEnd">  <br/>
				<label>입실 시간</label>
				<input type="time" name="checkIn"> - <input type="time" name="checkOut">  <br/>
				<label>캠핑장 운영 정책</label> <br/>
				<textarea name="policy"  rows="10" cols="65" placeholder="캠핑장의 운영 정책을 적어주세요."></textarea> <br/>
				<label>캠핑장 환불 정책</label> <br/>
				<textarea name="refund" rows="10" cols="65" placeholder="캠핑장을 환불 정책을 적어주세요."></textarea> <br/>
				...
				<div class="filter">
					...
					<div class="extra_fee">
						<label>어른 : </label><input type="text" name="extraAdult" placeholder="예) 30000"> <br/>
						<label>아이 : </label><input type="text" name="extraChild">
					</div>
		            <span>추가 옵션</span> <br/>
		            <div class="option">
		            </div>
				...
				<button type="button" class="btn_save" onclick="camp.input()">저장하기</button> <br/>
				<button type="button" class="btn_reset">취소</button>
			</div>
		</form>
		<form id="frm_att" method="post" enctype="multipart/form-data">
			<div>
				<input type="text" name="state" value="캠핑장등록요청">
				<input type="hidden" name="itemCode" value="${sessionScope.itemCode }">
