...
<head>
<meta charset="UTF-8">
<title>partner_account_modify</title>
		...
		<form name='frm_partner_modify' class='frm_partner_modify' method='post'>
			...
			<div class='partner_modify_input'>
				<div class='partner_info'>
					...
					<label>*비밀번호</label><input type='hidden' name='pwd' value='${vo.pwd}'/> 
					<button type='button' name='btn_partner_pwd_modify' class='btn_partner_pwd_modify' onclick='partner_account_modify.modiPwd(this.form)'>비밀번호 변경</button><br/>
					<span></span><br/><!-- 버튼 클릭 시 비밀번호 변경 페이지로 이동 -->
					
					<label>*성명</label>
					<input type='text' name='mName' id='cmName' value='${vo.mName}'/> <br/>
					<label></label><span id="cmNameValidation"></span><br/>
			
					<label>*연락처</label>
					<input type='text' name='phone' id='cPhone' value='${vo.phone}'/> <br/>
					<label></label><span id="cPhoneValidation"></span><br/>
			
					<label>*이메일</label>
					<input type='text' name='email' id='cEmail' value='${vo.email}'/> <br/>
				...
				<div class='account_info'>
					<h3>정산 정보</h3>
					<label>예금주</label>
					<input type='text' name='busiBankName' value='${vo.busiBankName}'><br/>
					<label>계좌번호</label>
					...
					<label></label>
					<input type='text' name='busiBankNum' value='${vo.busiBankNum}'><br/>
					<span></span><br/>
				</div>
				<div class='business_info'>
					<h3>사업자 정보</h3>
					<label>사업자명</label>
					<input type='text' name='busiName' value='${vo.busiName}'><br/>
					<span></span><br/>
					
					<label>대표자명</label>
					<input type='text' name='repName' value='${vo.repName}'><br/>
					<span></span><br/>
					
					<label>*사업자 등록번호</label>
					<input type="text" name="busiNum" id="cbusiNum" value="${vo.busiNum}" /><br/>
					<label></label><span id="cBusiNumValidation"></span><br>
						
					<label>관광사업(야영장) 등록번호</label>
					<input type="text" name="travelBus" value="${vo.travelBus}" /><br/>
					<span></span><br>
											
					<label>*세금계산서용 이메일</label>
					<input type='text' name='busiEmail' id='cbusiEmail' value='${vo.busiEmail}'><br/>
					<label></label><span id="cBusiEmailValidation"></span><br/>
					
					<label>대표 전화번호</label>
					<input type='text' name='busiPhone' value='${vo.busiPhone}'><br/>
					<span></span><br/>
			...
			<button type='button' name='btnmodify' class='btn_modify' onclick='partner_account_modify.modiReq(this.form)'>수정요청</button>
			<button type='button' name='btncancel' class='btn_cancel' onclick='partner_account_modify.cancel(this.form)'>취소</button>
			
			<div class='admin_permission' style='display:none'>
				<textarea class='regectMsg'></textarea><br/>
