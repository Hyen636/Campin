...
<head>
<meta charset="UTF-8">
<title>manager_request_modify</title>
<link rel="stylesheet" type="text/css" href="./css/manager/manager.css">
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@300&display=swap" rel="stylesheet">
</head>
<body>
<div id='manager_request_modify'>
		<form name='frm_manager_request_modify' class='frm_manager_request_modify' method='post'>
		
		<h2>요청사항 답변 수정</h2>
		
		<div class="review_att"><%-- 가지고 올 데이터 있을경우에만 활성화--%> 
		<img src="./image/img/partner_review2.jpg" width="100%"><%--리뷰시 리뷰건 가져오고--%>
		</div>
		...
		<div class='btns_request'>
			<button type='button' class='btn_request_update'>수정</button>
