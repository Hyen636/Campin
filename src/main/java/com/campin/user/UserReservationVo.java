...
public class UserReservationVo {
	...
	public String getSysFileC() {
		return sysFileC;
	}
	public void setSysFileC(String sysFileC) {
		this.sysFileC = sysFileC;
	}
	...
	public int getIoptSize() {
		return ioptSize;
	}
	public void setIoptSize(int ioptSize) {
		this.ioptSize = ioptSize;
	}
